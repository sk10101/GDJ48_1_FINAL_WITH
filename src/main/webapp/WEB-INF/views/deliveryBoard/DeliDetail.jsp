			...
			<table id="center-table">
				...
				<c:forEach items="${partList}" var="part">
					<tr>
						...
						<td><c:if test="${partMemberChk > 0 and info.member_id eq sessionScope.loginId and info.recruit_end eq 0}"><input id="elim" type="button" class="elim-button" value="강퇴" onclick="location='deliBan?board_idx=${info.board_idx}&member_id=${part.member_id}'"/></c:if></td>
					</tr>
				</c:forEach>
			</table>
