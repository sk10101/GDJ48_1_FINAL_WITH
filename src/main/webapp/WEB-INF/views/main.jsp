...
<body>
    <div class="main">
        ...
        <div class="navbar-top">
            ...
            <p><a href="#">${sessionScope.loginId}님 환영합니다.</a> &nbsp; | &nbsp; <a href="#">로그아웃</a></p>
            <a href="#"><img class="bell" src="./resources/images/bell.png" alt="bell"></a>
            <img class="dot" src="./resources/images/dot.png" alt="dot">
        </div>
        <div class="sidebar">
            <ul>
                <li><a href="/memberDeliMain"><img src="./resources/images/delivery.png" alt="delivery"><div class="circle"></div>배달</a></li>
                <li><a href="/taxi"><img src="./resources/images/taxi.png" alt="taxi"><div class="circle"></div>택시</a></li>
                <li><a href="/meal"><img class="eating" src="./resources/images/eating.png" alt="eating"><div class="circle"></div>식사</a></li>
