     	...
     	<table id="main-table">
				...
				<tbody class="taxiApplyList">
						<tr>
							...
							<td><input class="common-button no-button" type="button" value="거절" onclick="location.href='taxiApplyUpdate?apply_idx=${apply.apply_idx}&board_idx=${apply.board_idx}&category_id=${apply.category_id}&status=0'" /></td>
						</tr>
				</tbody>
				</c:forEach>
			</table>
