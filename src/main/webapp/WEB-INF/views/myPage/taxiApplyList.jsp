				...
				<tbody class="taxiApplyList">
						<tr>
							...
							<td>
								...
								<td><input type="button" value="수락" onclick="location.href='taxiApplyUpdate?apply_idx=${apply.apply_idx}&board_idx=${apply.board_idx}&status=1'" /></td>
								<td><input type="button" value="거절" onclick="location.href='taxiApplyUpdate?apply_idx=${apply.apply_idx}&board_idx=${apply.board_idx}&status=0'" /></td>
						</tr>
				</tbody>
				</c:forEach>
