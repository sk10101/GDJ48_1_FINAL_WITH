...
<body>
	...
	<div class="content-wrap">
	   ...
	   <div class="content">
	       <!-- 여기에서 작업 시작하세요 -->
	     <form action="mbUpdate.do" method="POST">
	     <table class="myinfo" style="margin-left:120px; margin-top:40px;">
            	...
            	<tr>
            		<th>PW확인</th>
            		<td><input id="member_pw" name="member_pw" type="password" required="required"/><p id=result></p></td>
            	</tr>
            	<tr>
            		<th>이름</th>
            		<td>${mblist.name}</td>
            	...
            	<tr>
            		<th>연락처</th>
            		<td><input type="text" id="phone" name="phone" value="${mblist.phone}" required="required"/></td>
            	</tr>
            	<tr>
            		<th>이메일</th>
            		<td>${mblist.email}</td>
            	...
            	<tr>
            		<th>회원탈퇴 신청</th>
            		<td><input id="hide" name="hide" type="radio" value="1"/>&emsp;
