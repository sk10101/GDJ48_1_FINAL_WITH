...
<body>
	...
	<div class="content-wrap">
	   ...
	   <div class="content">
	       <!-- 여기에서 작업 시작하세요 -->
	       <input class="common-button write-button" type="button" class="write-button" value="문의 작성" onclick="location.href='/inqueryWrite.go'"/>
	       <div class="search">
						...
						<tr>
							...
							<c:choose>
						         <c:when test="${name.status eq '미처리'}">
										<td><button class="common-button del-button" onclick="location.href='/inqueryDelete?idx=${name.inquery_idx}'">삭제</button></td>												
						         </c:when>
					         	<c:otherwise>
				         		<td></td>	
				        		 </c:otherwise>
...
<script type="text/javascript">
	...
	$("#pagination").twbsPagination({
		...
		onPageClick:function(e,page){
			...
			location.href = "inqueryList?page="+page;
		}
	});
</script>
</html>