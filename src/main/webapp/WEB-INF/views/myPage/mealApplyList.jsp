				...
				<tbody class="mealApplyList">
						<tr>
							...
							<td>
								...
								<td><input  class="common-button no-button" type="button" value="거절" onclick="location.href='mealApplyUpdate?apply_idx=${apply.apply_idx}&member_cnt=${apply.member_cnt}&member_id=${apply.member_id}&board_idx=${apply.board_idx}&category_id=${apply.category_id}&status=0'" /></td>
							</tr>
				</tbody>
				</c:forEach>
			</table>
